...
public class XPPotions {
    ...
    public static final Potion XP_HEALTH_DEBT_LVL1 = new Potion(new MobEffectInstance(Effects.XP_HEALTH_DEBT, -1, 0));
    public static final Potion XP_HEALTH_DEBT_LVL2 = new Potion(new MobEffectInstance(Effects.XP_HEALTH_DEBT, -1, 1));
    public static final Potion XP_HEALTH_DEBT_LVL3 = new Potion(new MobEffectInstance(Effects.XP_HEALTH_DEBT, -1, 2));
}
