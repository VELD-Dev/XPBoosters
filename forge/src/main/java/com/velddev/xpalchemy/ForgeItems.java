...
public class ForgeItems {
    ...
    public static void RegisterItems(IEventBus eventBus) {
        ...
        POTIONS_REGISTRY.register(XPPotions.XP_HEALTH_DEBT_LVL1_ID, () -> XPPotions.XP_HEALTH_DEBT_LVL1);
        POTIONS_REGISTRY.register(XPPotions.XP_HEALTH_DEBT_LVL2_ID, () -> XPPotions.XP_HEALTH_DEBT_LVL2);
        POTIONS_REGISTRY.register(XPPotions.XP_HEALTH_DEBT_LVL3_ID, () -> XPPotions.XP_HEALTH_DEBT_LVL3);
    }
    ...
    public static void RegisterBrewingRecipes(FMLCommonSetupEvent event) {
        ...
        PotionBrewing.addMix(Potions.THICK, Items.NAUTILUS_SHELL, XPPotions.XP_HEALTH_DEBT_LVL1);
        PotionBrewing.addMix(XPPotions.XP_HEALTH_DEBT_LVL1, Items.ECHO_SHARD, XPPotions.XP_HEALTH_DEBT_LVL2);
        PotionBrewing.addMix(XPPotions.XP_HEALTH_DEBT_LVL2, Items.ECHO_SHARD, XPPotions.XP_HEALTH_DEBT_LVL3);
    }
}
